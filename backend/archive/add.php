...
if ($imagename !="fail")
{
  $stmp = $con->prepare(" INSERT INTO `contract` (`contra_name`, `contra_date`, `user_id`,`contra_issigned`,`contra_salary`,`contra_image`) VALUES (?,?,?,?,?,?)");
  $stmp->execute(array(
   $contra_name,$contra_date,$user_id,$contra_issigned,$contra_salary,$imagename
  )); 
